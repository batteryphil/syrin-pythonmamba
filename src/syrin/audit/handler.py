...
_HOOK_TO_AUDIT_EVENT: dict[Hook, str] = {
    ...
    Hook.PIPELINE_START: AuditEventType.PIPELINE_START,
    Hook.PIPELINE_END: AuditEventType.PIPELINE_END,
    Hook.PIPELINE_AGENT_START: AuditEventType.PIPELINE_AGENT_START,
    Hook.PIPELINE_AGENT_COMPLETE: AuditEventType.PIPELINE_AGENT_COMPLETE,
